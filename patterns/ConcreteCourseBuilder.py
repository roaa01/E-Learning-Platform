class ConcreteCourseBuilder(CourseBuilder):
    ...
    def reset(self):
        self.course = Course(id=None, title="", description="", instructorId=None, category="", createdDate=datetime.now())
    ...
    def set_instructor(self, instructorId: str):
        self.course.instructorId = instructorId
        return self
    ...
    def add_module(self, module_title: str):
        module = Module(id=None, courseId=None, title=module_title)
    ...
    def add_lesson_to_module(self, module_index: int, lesson_title: str, lesson_content: str, lesson_type: str):
        if module_index < len(self.course.modules):
            lesson = Lesson(id=None, moduleId=None, title=lesson_title, content=lesson_content, type=lesson_type)
